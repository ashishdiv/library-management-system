	...
	<div class="container">
		...
		<div class="register">
			...
			<form action="index.php" method="post">
				...
				<input type="password" Name="Password" placeholder="Password" required>
				<input type="tel" id="phone" Name="PhoneNumber" pattern="[0-9]{10}" placeholder="Phone Number" required>
				<input type="number" Name="RollNo" placeholder="ID Number" required="">
           ...
           <option value="Electronics and Telecommunication">Electronics and Telecommunication</option>
			...
			<p>By creating an account, you are able to Sign In</p>
			<div class="clear"></div>
		</div>
